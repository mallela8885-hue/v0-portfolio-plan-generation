...
import { Mail, MapPin, Phone, Send, Loader2, CheckCircle, Github, Linkedin } from "lucide-react"

const contactInfo = [
  {
    icon: Mail,
    label: "Email",
    value: "mallelakranthikiran@gmail.com",
  ...
  },
  {
    ...
    label: "Phone",
    value: "+91 8885299384",
    href: "tel:+918885299384",
  },
  {
    icon: Github,
    label: "GitHub",
    value: "github.com/kranthikiran885366",
    href: "https://github.com/kranthikiran885366",
  },
  {
    icon: Linkedin,
    label: "LinkedIn",
    value: "Kranthi Kiran Mallela",
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <div className="text-center mb-16">
            ...
            <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold mb-4 text-balance">Let's Work Together</h2>
